...
const translations = {
    en: {
        ...
        'nav.clarityViewer': `Claarity Viewer`,
        ...
        'clarityViewer.eyebrow': `Case 02`,
        'clarityViewer.title': `Claarity Viewer`,
        'clarityViewer.tagline': `A DICOM viewer that shows medical images without confusion`,
        'clarityViewer.lead': `Claarity Viewer is a web-based DICOM viewer for CT, MR, PET and other medical images. It supports 3D volume rendering and MPR views, with 26 medical presets for optimal visualization by image type.`,
        'clarityViewer.cta': `Go to Claarity Viewer`,
        'clarityViewer.story1': `① File Loading: Drag or select DICOM files and 3D Volume is automatically constructed.`,
        'clarityViewer.story2': `② Multi-view: See Axial, Sagittal, Coronal, and 3D views simultaneously to locate positions.`,
        'clarityViewer.story3': `③ Measurement & Annotation: Measure length, area, and angles in mm units and record them.`,
        'clarityViewer.card1.title': `26 Volume Rendering Presets`,
        'clarityViewer.card1.desc': `From CT Bone, Soft-Tissue, Lung to MR Brain and PET—modality-optimized presets for clear visualization.`,
        'clarityViewer.card2.title': `MPR + 3D Simultaneous View`,
        'clarityViewer.card2.desc': `View Axial, Sagittal, Coronal planes and 3D Volume on one screen to pinpoint lesion locations.`,
        'clarityViewer.card3.title': `Precision Measurement Tools`,
        'clarityViewer.card3.desc': `Measure length, area, and angles in mm. Measurements are saved with images for comparison with previous records.`,
        'clarityViewer.card4.title': `Quality-Performance Control`,
        'clarityViewer.card4.desc': `1-16 step quality selector balances rendering speed and image quality. Works smoothly even in slower environments.`,
