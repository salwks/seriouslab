...
const translations = {
    en: {
        ...
        'clarityViewer.title': `Clarity Viewer`,
        'clarityViewer.tagline': `A DICOM viewer that shows medical images without confusion`,
        'clarityViewer.lead': `Clarity Viewer is a web-based DICOM viewer for CT, MR, PET and other medical images. It supports 3D volume rendering and MPR views, with 26 medical presets for optimal visualization by image type.`,
