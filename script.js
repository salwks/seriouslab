...
const translations = {
    en: {
        ...
        'hero.title': `An independent research team<br>obsessively experimenting on life bugs`,
        'hero.subtitle': `We prefer data experiments that make days less draining over prettier UX.`,
        'hero.description': `When we find friction, we log it and run small experiments. Automation and tools are just means; humans decide. We confirm "a bit better" with numbers, not vibes.`,
        ...
        'about.subtitle': `A data research team that makes everyday life less tedious`,
        'about.p1': `When we hear "that's just how it is," we start logging where time and energy leak. Watching discomfort is dull; turning it into experiment fuel isn't.`,
        'about.p2': `We like automation and tools, but decisions and priorities stay human. If numbers don't move, new tools don't matter.`,
        'about.p3': `The goal isn't grand innovation but "a slightly less tiring day." We leave evidence that life actually improved through experiments and records.`,
        'about.keyword1.title': `Instrument Daily Life`,
        'about.keyword1.desc': `We first record where time, energy, and money drain.`,
        'about.keyword2.title': `Tools as Means`,
        'about.keyword2.desc': `Automation and models are fast hands; humans keep the veto.`,
        'about.keyword3.title': `Humans as Brake`,
        'about.keyword3.desc': `If automation slips, we stop and reset with human judgment.`,
        'philosophy.title': `Philosophy`,
        'philosophy.subtitle': `Instrument, Experiment, Decide`,
        'philosophy.intro': `We don't rely on gut alone. We loop through instrument → hypothesis → experiment → recovery/improvement checks. We stay skeptical of tools and cold with numbers.`,
        ...
        'philosophy.card2.desc': `Automation and models draft and sort. They don't get decision rights.`,
        'philosophy.card3.title': `Humans Are the Brake`,
        'philosophy.card3.desc': `Human-in-the-loop is mandatory. If automation goes off, we stop and feed the mistake back.`,
        'philosophy.card4.title': `Choose by Numbers`,
        'philosophy.card4.desc': `We pick by uplift, recovery, and reproducibility. Ideas that don't move numbers get dropped.`,
        'lab.title': `Lab Notes`,
        'lab.subtitle': `We don't hide failures or improvements`,
        'lab.intro': `We prefer raw logs over polished results, because reflection fuels the next experiment.`,
        'lab.note1.label': `Note #01`,
        'lab.note1.title': `Budgets ignore tomorrow`,
        'lab.note1.desc': `Even tidy spend summaries missed "future me." Reclassifying spend by future impact finally nudged behavior.`,
        'lab.note1.status': `Collecting next month's data; nagging intensity trimmed 30%.`,
        'lab.note2.label': `Note #02`,
        'lab.note2.title': `Meeting notes erased conflict`,
        'lab.note2.desc': `Auto-summarized notes deleted every tension. Extracting only "unresolved items" to Slack shortened meetings.`,
        'lab.note2.status': `Conflict extraction precision 0.78; tone still in tuning.`,
        'lab.note3.label': `Note #03`,
        'lab.note3.title': `Routine recs outran stamina`,
        'lab.note3.desc': `Morning routines built without biometrics treated humans like robots. Adding heart-rate/sleep and a "can you actually?" score raised adherence.`,
        'lab.note3.status': `Adherence +19%. Scoring remains flimsy.`,
        'lab.note4.label': `Note #04`,
        'lab.note4.title': `Fewer notifications, fewer logs`,
        'lab.note4.desc': `Filtering to only necessary alerts also shrank user logs. We added quick "why not" surveys and are retraining.`,
        'lab.note4.status': `Response rate 14% → 31%. Behavior shift still watching.`,
        'experiments.title': `Experiments`,
        'experiments.subtitle': `Problem, Hypothesis, Experiment, Evidence`,
        'experiments.intro': `We repeat problem–hypothesis–experiment–result. Tools and data are just opinions until proven.`,
        ...
        'experiments.exp1.problem': `Auto-tagging mislabels customer tickets; 37% bounce back for rework.`,
        'experiments.exp1.hypothesis': `If we cite product schemas/FAQs and allow "unknown," misfires should drop.`,
        ...
        'experiments.exp1.result': `Accuracy +19pts, rework 37%→11%, handling time +6s. Slightly slower, but trust recovered.`,
        ...
        'experiments.exp3.hypothesis': `A one-page Slack drop with week-over-week deltas/causes/next tests beats a number-only digest.`,
        'experiments.exp3.experiment': `Every Friday, metric diffs are auto-summarized with evidence links and posted. Watched open rates and meeting time for 6 weeks.`,
        'experiments.exp3.result': `Opens 3×, weekly meetings -18 minutes. Two misreads triggered a new "uncertainty" section.`,
        'studio.title': `Labs`,
        'studio.subtitle': `How we operate`,
        'studio.intro': `We're not an agency. We're a cluster of small labs by interest—measuring life, experimenting with tools, and archiving even the failures.`,
        ...
        'studio.value2.desc': `Automation and models draft and classify. Decisions come from numbers and humans.`,
